...
export default function AddClient({ itemId }) {
  ...
  const handleUserUpdate = (data) => {
    setUpdateForm({ name: data.name, fname: data.fname, mobileno: data.mobileno, dob: data.dob, weight: data.weight, address: data.address, image: data.image, _id: data._id })
  }
        ...
        <div>
          <div className={style.main_div}>
            <div className={style.inner_div}>
              <div style={{ fontSize: "25px", fontWeight: "600" }}>All Clients</div>
                        ...
                        return <>
                          ...
                          >
                            ...
                            <TableCell style={{ padding: "10px" }} align='center'>
                              {/* <ul>
                                <li style={{ color: "red" }}>{row.checkedValues}</li>
                              </ul> */}
                              {
                            ...
                            {/* ==========btns div=========== */}
                            <TableCell align="right" style={{ display: "flex", gap: "10px", flexDirection: "column", alignContent: "center", justifyContent: "center", padding: "10px" }}>
                    ...
                    <div className={style1.inner_div}>
                      ...
                      <div style={{ margin: "20px 0" }}>
                        {/* <div className={style.input_div}>
                          ...
                          <input type="file" name="image" id="" accept="image/*" onChange={(e) => setImage(e.target.files[0])} className={style.image} />
                        </div> */}
